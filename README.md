...
| Library   | Median (ms) | Operations per second | Output size (KiB) |
|:----------|------------:|----------------------:|------------------:|
| msgpack   |        6.18 |                161.79 |              1032 |
| ormsgpack |        2.47 |                404.67 |              1032 |

#### canada deserialization

| Library   | Median (ms) | Operations per second |
|:----------|------------:|----------------------:|
| msgpack   |        8.71 |                116.76 |
| ormsgpack |        7.22 |                138.48 |

#### citm_catalog serialization

| Library   | Median (ms) | Operations per second | Output size (KiB) |
|:----------|------------:|----------------------:|------------------:|
| msgpack   |        2.90 |                345.07 |               334 |
| ormsgpack |        1.20 |                830.66 |               334 |

#### citm_catalog deserialization

| Library   | Median (ms) | Operations per second |
|:----------|------------:|----------------------:|
| msgpack   |        4.94 |                202.31 |
| ormsgpack |        4.50 |                222.26 |

#### github serialization

| Library   | Median (ms) | Operations per second | Output size (KiB) |
|:----------|------------:|----------------------:|------------------:|
| msgpack   |        0.10 |               9997.15 |                47 |
| ormsgpack |        0.05 |              21807.12 |                47 |

#### github deserialization

| Library   | Median (ms) | Operations per second |
|:----------|------------:|----------------------:|
| msgpack   |        0.29 |               3473.47 |
| ormsgpack |        0.23 |               4266.01 |

#### twitter serialization

| Library   | Median (ms) | Operations per second | Output size (KiB) |
|:----------|------------:|----------------------:|------------------:|
| msgpack   |        1.13 |                881.63 |               392 |
| ormsgpack |        0.52 |               1923.07 |               392 |

#### twitter deserialization

| Library   | Median (ms) | Operations per second |
|:----------|------------:|----------------------:|
| msgpack   |        3.26 |                306.50 |
| ormsgpack |        2.76 |                363.49 |

#### dataclass serialization

| Library   | Median (ms) | Operations per second | Output size (KiB) |
|:----------|------------:|----------------------:|------------------:|
| msgpack   |       94.21 |                 10.70 |               335 |
| ormsgpack |        4.29 |                233.27 |               335 |

#### numpy bool serialization

| Library   | Median (ms) | Operations per second | Output size (KiB) |
|:----------|------------:|----------------------:|------------------:|
| msgpack   |      678.16 |                  1.46 |             19824 |
| ormsgpack |      209.95 |                  4.76 |             19824 |

#### numpy float64 serialization

| Library   | Median (ms) | Operations per second | Output size (KiB) |
|:----------|------------:|----------------------:|------------------:|
| msgpack   |      367.78 |                  2.72 |             44091 |
| ormsgpack |       37.41 |                 26.74 |             44091 |

#### numpy int32 serialization

| Library   | Median (ms) | Operations per second | Output size (KiB) |
|:----------|------------:|----------------------:|------------------:|
| msgpack   |      957.18 |                  1.02 |             49120 |
| ormsgpack |      124.63 |                  7.88 |             49120 |

#### pydantic serialization

| Library   | Median (ms) | Operations per second | Output size (KiB) |
|:----------|------------:|----------------------:|------------------:|
| msgpack   |       37.94 |                 26.34 |               335 |
| ormsgpack |        4.87 |                204.82 |               335 |

### Reproducing

The above was measured using Python 3.11.2 on Debian 12 (x86_64) with ormsgpack 1.4.1 and msgpack 1.0.7.

The latency results can be reproduced using `./scripts/benchmark`.
