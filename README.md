...
The above was measured using Python 3.11.2 on Debian 12 (x86_64) with ormsgpack 1.7.0 and msgpack 1.1.0.

The benchmark results can be reproduced using `./scripts/benchmark.py`.
