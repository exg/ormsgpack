...
use crate::exc::RECURSION_LIMIT_REACHED;
use crate::ffi::*;
use crate::opt::*;
use crate::typeref::*;
use crate::unicode::*;
...
impl Display for Error {
    ...
    fn fmt(&self, fmt: &mut Formatter<'_>) -> Result<(), fmt::Error> {
        match *self {
            ...
            Error::InternalError => fmt.write_str("internal error"),
...
impl<'de> Deserializer<'de> {
    ...
    fn read_f32(&mut self) -> Result<f32, Error> {
        self.data.read_f32::<BigEndian>().map_err(Error::IOError)
    }

    #[inline]
    fn read_f64(&mut self) -> Result<f64, Error> {
        self.data.read_f64::<BigEndian>().map_err(Error::IOError)
    }

    #[inline]
    fn read_i8(&mut self) -> Result<i8, Error> {
        self.data.read_i8().map_err(Error::IOError)
    }

    #[inline]
    fn read_i16(&mut self) -> Result<i16, Error> {
        self.data.read_i16::<BigEndian>().map_err(Error::IOError)
    }

    #[inline]
    fn read_i32(&mut self) -> Result<i32, Error> {
        self.data.read_i32::<BigEndian>().map_err(Error::IOError)
    }

    #[inline]
    fn read_i64(&mut self) -> Result<i64, Error> {
        self.data.read_i64::<BigEndian>().map_err(Error::IOError)
    }

    #[inline]
    fn read_u8(&mut self) -> Result<u8, Error> {
        self.data.read_u8().map_err(Error::IOError)
    }

    #[inline]
    fn read_u16(&mut self) -> Result<u16, Error> {
        self.data.read_u16::<BigEndian>().map_err(Error::IOError)
    }

    #[inline]
    fn read_u32(&mut self) -> Result<u32, Error> {
        self.data.read_u32::<BigEndian>().map_err(Error::IOError)
    }

    #[inline]
    fn read_u64(&mut self) -> Result<u64, Error> {
        self.data.read_u64::<BigEndian>().map_err(Error::IOError)
    }
    ...
    fn deserialize_bin(
        ...
        let len = data.len() as pyo3::ffi::Py_ssize_t;
    ...
    fn deserialize_map_with_non_str_keys(
        ...
        let dict_ptr = ffi!(_PyDict_NewPresized(size as pyo3::ffi::Py_ssize_t));
        for _ in 0..size {
