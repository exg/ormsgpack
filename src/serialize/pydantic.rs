...
impl State {
    ...
    pub fn new(py: Python<'_>) -> Self {
        unsafe {
            Self {
                fields_str: Py::from_bound(PyString::intern(py, "__fields__")),
                pydantic_extra_str: Py::from_bound(PyString::intern(py, "__pydantic_extra__")),
                pydantic_validator_str: Py::from_bound(PyString::intern(
                    py,
